...
- [lean-quantfinance](https://huggingface.co/datasets/seancollins/lean-quantfinance) — **2,074 machine-checked Lean 4 theorems** on Hugging Face (99.8% sorry-free): quantitative finance, game theory, mechanism design, information theory. Statement–proof pairs.
...
- [voynich-eva-stats](https://huggingface.co/datasets/seancollins/voynich-eva-stats) — Voynich EVA corpus statistics on Hugging Face: glyph/bigram frequencies + Shannon/Miller–Madow entropy over the Takahashi transcription.
